...
namespace DataAccess.Migrations
{
    ...
    [Migration("20211016170245_AddStudioAndStudioDetailTables")]
    partial class AddStudioAndStudioDetailTables
    {
            ...
            modelBuilder.Entity("Entities.Models.StudioDetail", b =>
                {
                    b.HasOne("Entities.Models.Studio", "Studio")
                        .WithOne("StudioDetail")
                        .HasForeignKey("Entities.Models.StudioDetail", "StudioId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
